...
interface PlayerProps {
  bookTitle: string;
  onChangeBook: (title: string) => void;
  onHome: () => void;
}

export function Player({ bookTitle, onChangeBook, onHome }: PlayerProps) {
  const {
    engine,
    ensureEngine,
    status: sfStatus,
  ...
  return (
    <div className="app">
      <header className="app-header">
        <button type="button" className="brand brand-home" onClick={onHome} title="Back to home">
        ...
        <label className="book-select">
          ...
          <select value={bookTitle} onChange={(e) => onChangeBook(e.target.value)}>
            {BOOK_TITLES.map((t) => (
